...
Usage:
    python3 scripts/apply_results.py --output-file ./runs/round-1.json --task-source ./tasks.md
    python3 scripts/apply_results.py --output-file ./runs/round-1.json --task-source ./tasks.md --dry-run
    python3 scripts/apply_results.py --output-file ./runs/round-1.json --task-source ./tasks.md --results-file ./results.json
"""
